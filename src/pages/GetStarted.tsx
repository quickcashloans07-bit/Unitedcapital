...
const loanTypes = [
  {
    ...
    features: ["$1,000 - $10,000", "Quick approval", "Flexible repayment"],
    link: "/apply/personal",
  },
  {
    icon: Rocket,
    ...
    features: ["$10,000 - $25,000", "Startup-friendly terms", "Business guidance"],
    link: "/apply/startup",
  },
  {
    icon: Building,
    ...
    features: ["$25,000 - $100,000", "Competitive rates", "Scalable solutions"],
    link: "/apply/business",
  },
];
